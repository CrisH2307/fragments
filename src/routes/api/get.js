...
const { readFragmentData } = require('../../model/data/memory');
...
const getAllFragment = async (req, res) => {
  ...
  try {
    ...
    const errorResponse = createErrorResponse(
      500,
      'Internal error to get all fragment of user',
      err
    );
...
const getInfo = async (req, res) => {
  try {
    ...
    const errorResponse = createErrorResponse(404, 'not found', err);
